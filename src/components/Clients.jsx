    ...
    <div className="flex flex-col gap-12   md:px-[180px] mt-12 pb-16">
      <div>
        ...
        <div className="flex flex-col flex-wrap  items-center text-neutral-600 lg:flex-row lg:flex-nowrap justify-between gap-8  ">
          <div className="flex flex-row gap-[1px]  font-bold border-neutral-800 rounded-[4px] border-[1px] h-[60px] w-[160px] flex items-center justify-center">
            <SiClickup fontSize={20} />
            <h1 className=" font-bold text-[18px]">ClickUp</h1>
          </div>
          <div className="flex flex-row gap-[1px] border-neutral-800 rounded-[4px] border-[1px] h-[60px] w-[160px] flex items-center justify-center">
          ...
          <div className=" border-neutral-800 rounded-[4px] border-[1px] h-[60px] w-[160px] flex items-center justify-center ">
            <SiPaychex className=" font-bold text-[80px]" />
          </div>
          <div className="flex flex-row gap-[1px]  font-bold border-neutral-800 rounded-[4px] border-[1px] h-[60px] w-[160px] flex items-center justify-center">
            <GrDropbox fontSize={20} />
            <h1 className=" text-[21px]">Dropbox</h1>
          </div>
          <div className="font-bold border-neutral-800 rounded-[4px] border-[1px] h-[60px] w-[160px] flex items-center justify-center">
            <FaStripe className=" font-bold text-[60px]" />
          </div>
        </div>
      </div>
    </div>

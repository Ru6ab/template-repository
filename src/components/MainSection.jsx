  ...
  return (
    ...
    >
      <div className="w-full md:w-[538px] h-auto flex flex-col gap-6 text-center md:text-left">
        <h1 className="font-bold text-white text-3xl text-[25px] md:text-[30px] lg:text-[44px] raleway-font">
          Your Name Here
        </h1>
        <p className="ibm-font text-[12px]  md:text-[13px] font-medium text-neutral-400 max-w-full md:max-w-[460px] tracking-widest leading-loose mx-auto md:mx-0">
          Intro text: Lorem ipsum dolor sit amet, consectetur adipiscing elit,
          sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
        </p>
        <button
          className="bg-lime-700  w-full md:w-[307px] h-[63px] py-[21px] rounded

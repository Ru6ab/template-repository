...
export const  CaseStudies=()=> {
  return (
    <div id='caseStudy' className="flex flex-col bg-white pt-20 pb-20">
      ...
      <div className="flex flex-col gap-20  pt-16 px-[180px]">
        <div className="flex flex-row gap-8   ">
          ...
          <img src={image2} className="rounded-[6px] w-[445px]" />
        </div>

        <div className="flex flex-row justify-center items-center gap-4 w-[897px]  ">
        
          <img src={image1} className="rounded-[6px] h-[300px] w-[445px]" />
          <div className=" w-[445px] px-4">
        ...
        <div className="flex flex-row justify-center items-center gap-8  ">
          ...
          <img src={image3} className="rounded-[6px]" />
        </div>
      </div>
    </div>
  );
